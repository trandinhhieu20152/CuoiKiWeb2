...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('front-end/assets/css/owl.theme.css')}}">
        <link rel="stylesheet" href="{{asset('front-end/assets/css/style.css')}}">


        <!-- scripts -->
        <script type="text/javascript" src="{{asset('front-end/assets/js/modernizr.custom.97074.js')}}"></script>
        <!-- Styles -->
        <style>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <span class="sr-only">Messages VinaBDS</span>
                        <a href="index.html">
                            <img src="{{asset('front-end/assets/img/main_logo.png')}}" class="img-responsive center-block" alt="logo">
                        </a>
                    </div>
                    <!-- navbar logo -->
            ...
            <div class="header-wrapper-inner">
                <div class="container">
                    ...
                    <div class="welcome-speech">
                        <h1>Welcome messages to Admin</h1>
                    </div><!-- /.intro -->
